...
export const researchItems: ResearchItem[] = [
  {
    ...
    outputs: [
      {
        label: "Macro dashboard notes",
        detail: "Indicator definitions + interpretation rules",
      },
      {
        label: "Regime framework",
        detail: "Labels, transition rules, and evaluation checks",
      },
    ],
  },

  {
    ...
    outputs: [
      { label: "Topic briefs", detail: "Short synthesis notes by theme" },
    ],
  },
  {
